...
So kann die erste Zeile aller gefundenen Dateien ausgegeben werden:
...
## Übungen mehrere Dateien

schwer: marode Infrastruktur? Verkehrsdaten von <https://unfallatlas.statistikportal.de/> abgerufen am 13.09.2024
...
- Dateien mit glob durchgehen und Spaltennamen mit str.replace vereinheitlichen. (try Spalte extrahieren STRZUSTAND, else USTRZUSTAND, ...)

- mit NumPy kann man leicht mehrdimensionale Dateien einlesen, die Werte sind alle numerisch.
