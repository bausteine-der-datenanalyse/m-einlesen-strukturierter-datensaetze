...
Tipp: Spalten immer einen Datentyp zuweisen, auch wenn sie als object eingelesen werden. Wenn es nicht klappt, weiß man, dass Fehler in den Daten sind.

### Aufgabe Datentypen
**Installierte_Erzeugungsleistung_202301010000_202401010000_Jahr.csv einlesen: zwei Datumsspalten, Rest als Integer (abschneiden der Nachkommastellen).**
...
**merken: das Objekt wird als object eingelesen, dass wird gleich überprüft.**
