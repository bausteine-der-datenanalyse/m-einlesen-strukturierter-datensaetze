...
## Fehlende Werte in Pandas finden, löschen, erzeugen, ersetzen
...
## Fehlende Werte in NumPy finden, löschen, erzeugen, ersetzen
...
NumPy.nan??? np.isnan(), np.argwhere() findet den index (erster Index mit min())
...
::: {.border layout="[[5, 90, 5], [1], [5, 90, 5], [1], [1]]"}
...
## Fehlende Werte finden, löschen, erzeugen, ersetzen
**Das gehört eher zu Strategien der Fehlersuche und Bereinigung, weil man erst mit describe() und anderen Funktionen einen Überblick über die verwendeten Zeichen zur Kennzeichnung fehlender Werte gewinnen muss (None und NaN ist nicht alles).**
