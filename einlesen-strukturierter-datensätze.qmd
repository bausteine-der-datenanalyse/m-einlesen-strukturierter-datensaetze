...
Das Modul NumPy bietet Funktionen, um mit fehlenden Werten zu arbeiten.
  ...
  **Geht das nicht einfacher?! `np.argwhere(np.isnan(array))` ... aber in der Doku steht: The output of argwhere is not suitable for indexing arrays. For this purpose use nonzero(a) instead. <https://numpy.org/doc/stable/reference/generated/numpy.argwhere.html> Mit eindimensionalen Array klappt aber beides, zweidimensional ist es anders**
